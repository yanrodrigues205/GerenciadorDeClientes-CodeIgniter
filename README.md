...
- Banco de Dados: Verifique de estar utilizando o banco de dados relacional MySql, e que o mesmo esteja alocado na porta default (:3306), crie um banco de dados com o nome de "amzmp", certifique que o servidor está rodando. <pre>default = http://localhost:3306/ </pre>
